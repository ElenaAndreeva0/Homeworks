...
Методы get_model, get_horsepower, get_color находятся в одном классе с соответствующими им атрибутами: __model, __engine_power, __color.
...
class Vehicle():
    ...
    __COLOR_VARIANTS = ['transparent', 'silver', 'blue', 'red', 'green', 'black', 'white']
    ...
    def set_color(self, new_color):
        ...
        if new_color.lower() in Vehicle.__COLOR_VARIANTS:
            ...
            print(f'Нельзя покрасить в {new_color}')

class Sedan(Vehicle):

    __PASSENGERS_LIMIT = 5
    # здесь нужно что-то еще добавлять?
    pass
